...
# USAGE: python postgres_get_server_cert.py {aws-database-server}:{port} > aws-cert.crt
# Example: python postgres_get_server_cert.py postgres-db-url.com:5432 > aws-cert.crt
# python v: 2.7
